class PinsController < ApplicationController
  before_action :set_pin, only: [:show, :edit, :update, :destroy]
	# uwierzytelnienie usera z wyjatkiem stron index i show
	before_action :authenticate_user!, except: [:index, :show]
	# tylko correct_user moze go zmieniac, kasowac
	# correct_user jest zdefiniowane jako metoda na koncu tego pliku
